 ...
 * lg-thumbnail plugin
 */
(function () { var k = { thumbnail: !0, animateThumb: !0, currentPagerPosition: "middle", thumbWidth: 100, thumbContHeight: 100, thumbMargin: 5, exThumbImage: !1, showThumbByDefault: !0, toogleThumb: !0, pullCaptionUp: !0, enableThumbDrag: !0, enableThumbSwipe: !0, swipeThreshold: 50, loadYoutubeThumbnail: !0, youtubeThumbSize: 1, loadVimeoThumbnail: !0, vimeoThumbSize: "thumbnail_small", loadDailymotionThumbnail: !0 }, g = function (a) { this.core = $(a).data("lightGallery"); this.core.s = $.extend({}, k, this.core.s); this.$el = $(a); this.$thumbOuter = null; this.thumbOuterWidth = 0; this.thumbTotalWidth = this.core.$items.length * (this.core.s.thumbWidth + this.core.s.thumbMargin); this.thumbIndex = this.core.index; this.left = 0; this.init(); return this }; g.prototype.init = function () { var a = this; this.core.s.thumbnail && 1 < this.core.$items.length && (this.core.s.showThumbByDefault && setTimeout(function () { a.core.$outer.addClass("lg-thumb-open") }, 700), this.core.s.pullCaptionUp && this.core.$outer.addClass("lg-pull-caption-up"), this.build(), this.core.s.animateThumb ? (this.core.s.enableThumbDrag && !this.core.isTouch && this.core.doCss() && this.enableThumbDrag(), this.core.s.enableThumbSwipe && this.core.isTouch && this.core.doCss() && this.enableThumbSwipe(), this.thumbClickable = !1) : this.thumbClickable = !0, this.toogle(), this.thumbkeyPress()) }; g.prototype.build = function () { function a(a, c, d) { a = b.core.isVideo(a, d) || {}; var h; d = ""; a.youtube || a.vimeo || a.dailymotion ? a.youtube ? h = b.core.s.loadYoutubeThumbnail ? "//img.youtube.com/vi/" + a.youtube[1] + "/" + b.core.s.youtubeThumbSize + ".jpg" : c : a.vimeo ? b.core.s.loadVimeoThumbnail ? (h = "//i.vimeocdn.com/video/error_" + f + ".jpg", d = a.vimeo[1]) : h = c : a.dailymotion && (h = b.core.s.loadDailymotionThumbnail ? "//www.dailymotion.com/thumbnail/video/" + a.dailymotion[1] : c) : h = c; e += '<div data-vimeo-id="' + d + '" class="lg-thumb-item" style="width:' + b.core.s.thumbWidth + "px; margin-right: " + b.core.s.thumbMargin + 'px"><img src="' + h + '" /></div>' } var b = this, e = "", f = "", d; switch (this.core.s.vimeoThumbSize) { case "thumbnail_large": f = "640"; break; case "thumbnail_medium": f = "200x150"; break; case "thumbnail_small": f = "100x75" }b.core.$outer.addClass("lg-has-thumb"); b.core.$outer.find(".lg").append('<div class="lg-thumb-outer"><div class="lg-thumb lg-group"></div></div>'); b.$thumbOuter = b.core.$outer.find(".lg-thumb-outer"); b.thumbOuterWidth = b.$thumbOuter.width(); b.core.s.animateThumb && b.core.$outer.find(".lg-thumb").css({ width: b.thumbTotalWidth + "px", position: "relative" }); this.core.s.animateThumb && b.$thumbOuter.css("height", b.core.s.thumbContHeight + "px"); if (b.core.s.dynamic) for (var c = 0; c < b.core.s.dynamicEl.length; c++)a(b.core.s.dynamicEl[c].src, b.core.s.dynamicEl[c].thumb, c); else b.core.$items.each(function (c) { b.core.s.exThumbImage ? a($(this).attr("href") || $(this).attr("data-src"), $(this).attr(b.core.s.exThumbImage), c) : a($(this).attr("href") || $(this).attr("data-src"), $(this).find("img").attr("src"), c) }); b.core.$outer.find(".lg-thumb").html(e); d = b.core.$outer.find(".lg-thumb-item"); d.each(function () { var a = $(this), c = a.attr("data-vimeo-id"); c && $.getJSON("//www.vimeo.com/api/v2/video/" + c + ".json?callback=?", { format: "json" }, function (c) { a.find("img").attr("src", c[0][b.core.s.vimeoThumbSize]) }) }); d.eq(b.core.index).addClass("active"); b.core.$el.on("onBeforeSlide.lg.tm", function () { d.removeClass("active"); d.eq(b.core.index).addClass("active") }); d.on("click.lg touchend.lg", function () { var a = $(this); setTimeout(function () { if (b.thumbClickable && !b.core.lgBusy || !b.core.doCss()) b.core.index = a.index(), b.core.slide(b.core.index, !1, !0, !1) }, 50) }); b.core.$el.on("onBeforeSlide.lg.tm", function () { b.animateThumb(b.core.index) }); $(window).on("resize.lg.thumb orientationchange.lg.thumb", function () { setTimeout(function () { b.animateThumb(b.core.index); b.thumbOuterWidth = b.$thumbOuter.width() }, 200) }) }; g.prototype.setTranslate = function (a) { this.core.$outer.find(".lg-thumb").css({ transform: "translate3d(-" + a + "px, 0px, 0px)" }) }; g.prototype.animateThumb = function (a) { var b = this.core.$outer.find(".lg-thumb"); if (this.core.s.animateThumb) { var e; switch (this.core.s.currentPagerPosition) { case "left": e = 0; break; case "middle": e = this.thumbOuterWidth / 2 - this.core.s.thumbWidth / 2; break; case "right": e = this.thumbOuterWidth - this.core.s.thumbWidth }this.left = (this.core.s.thumbWidth + this.core.s.thumbMargin) * a - 1 - e; this.left > this.thumbTotalWidth - this.thumbOuterWidth && (this.left = this.thumbTotalWidth - this.thumbOuterWidth); 0 > this.left && (this.left = 0); this.core.lGalleryOn ? (b.hasClass("on") || this.core.$outer.find(".lg-thumb").css("transition-duration", this.core.s.speed + "ms"), this.core.doCss() || b.animate({ left: -this.left + "px" }, this.core.s.speed)) : this.core.doCss() || b.css("left", -this.left + "px"); this.setTranslate(this.left) } }; g.prototype.enableThumbDrag = function () { var a = this, b = 0, e = 0, f = !1, d = !1, c = 0; a.$thumbOuter.addClass("lg-grab"); a.core.$outer.find(".lg-thumb").on("mousedown.lg.thumb", function (c) { a.thumbTotalWidth > a.thumbOuterWidth && (c.preventDefault(), b = c.pageX, f = !0, a.core.$outer.scrollLeft += 1, --a.core.$outer.scrollLeft, a.thumbClickable = !1, a.$thumbOuter.removeClass("lg-grab").addClass("lg-grabbing")) }); $(window).on("mousemove.lg.thumb", function (g) { f && (c = a.left, d = !0, e = g.pageX, a.$thumbOuter.addClass("lg-dragging"), c -= e - b, c > a.thumbTotalWidth - a.thumbOuterWidth && (c = a.thumbTotalWidth - a.thumbOuterWidth), 0 > c && (c = 0), a.setTranslate(c)) }); $(window).on("mouseup.lg.thumb", function () { d ? (d = !1, a.$thumbOuter.removeClass("lg-dragging"), a.left = c, Math.abs(e - b) < a.core.s.swipeThreshold && (a.thumbClickable = !0)) : a.thumbClickable = !0; f && (f = !1, a.$thumbOuter.removeClass("lg-grabbing").addClass("lg-grab")) }) }; g.prototype.enableThumbSwipe = function () { var a = this, b = 0, e = 0, f = !1, d = 0; a.core.$outer.find(".lg-thumb").on("touchstart.lg", function (c) { a.thumbTotalWidth > a.thumbOuterWidth && (c.preventDefault(), b = c.originalEvent.targetTouches[0].pageX, a.thumbClickable = !1) }); a.core.$outer.find(".lg-thumb").on("touchmove.lg", function (c) { a.thumbTotalWidth > a.thumbOuterWidth && (c.preventDefault(), e = c.originalEvent.targetTouches[0].pageX, f = !0, a.$thumbOuter.addClass("lg-dragging"), d = a.left, d -= e - b, d > a.thumbTotalWidth - a.thumbOuterWidth && (d = a.thumbTotalWidth - a.thumbOuterWidth), 0 > d && (d = 0), a.setTranslate(d)) }); a.core.$outer.find(".lg-thumb").on("touchend.lg", function () { a.thumbTotalWidth > a.thumbOuterWidth ? f ? (f = !1, a.$thumbOuter.removeClass("lg-dragging"), Math.abs(e - b) < a.core.s.swipeThreshold && (a.thumbClickable = !0), a.left = d) : a.thumbClickable = !0 : a.thumbClickable = !0 }) }; g.prototype.toogle = function () { var a = this; a.core.s.toogleThumb && (a.core.$outer.addClass("lg-can-toggle"), a.$thumbOuter.append('<span class="lg-toogle-thumb lg-icon"></span>'), a.core.$outer.find(".lg-toogle-thumb").on("click.lg", function () { a.core.$outer.toggleClass("lg-thumb-open") })) }; g.prototype.thumbkeyPress = function () { var a = this; $(window).on("keydown.lg.thumb", function (b) { 38 === b.keyCode ? (b.preventDefault(), a.core.$outer.addClass("lg-thumb-open")) : 40 === b.keyCode && (b.preventDefault(), a.core.$outer.removeClass("lg-thumb-open")) }) }; g.prototype.destroy = function () { this.core.s.thumbnail && 1 < this.core.$items.length && ($(window).off("resize.lg.thumb orientationchange.lg.thumb keydown.lg.thumb"), this.$thumbOuter.remove(), this.core.$outer.removeClass("lg-has-thumb")) }; $.fn.lightGallery.modules.Thumbnail = g })();
/**
 ...
 */
!function (a, b) { "function" == typeof define && define.amd ? define(["jquery"], function (a) { return b(a) }) : "object" == typeof exports ? module.exports = b(require("jquery")) : b(jQuery) }(this, function (a) { !function () { "use strict"; var b = { share: !0, facebook: !0, facebookDropdownText: "Facebook", twitter: !0, twitterDropdownText: "Twitter", googlePlus: !0, googlePlusDropdownText: "GooglePlus", pinterest: !0, pinterestDropdownText: "Pinterest" }, c = function (c) { return this.core = a(c).data("lightGallery"), this.core.s = a.extend({}, b, this.core.s), this.core.s.share && this.init(), this }; c.prototype.init = function () { var b = this, c = '<span id="lg-share" class="lg-icon"><ul class="lg-dropdown" style="position: absolute;">'; c += b.core.s.facebook ? '<li><a id="lg-share-facebook" target="_blank"><span class="lg-icon"></span><span class="lg-dropdown-text">' + this.core.s.facebookDropdownText + "</span></a></li>" : "", c += b.core.s.twitter ? '<li><a id="lg-share-twitter" target="_blank"><span class="lg-icon"></span><span class="lg-dropdown-text">' + this.core.s.twitterDropdownText + "</span></a></li>" : "", c += b.core.s.googlePlus ? '<li><a id="lg-share-googleplus" target="_blank"><span class="lg-icon"></span><span class="lg-dropdown-text">' + this.core.s.googlePlusDropdownText + "</span></a></li>" : "", c += b.core.s.pinterest ? '<li><a id="lg-share-pinterest" target="_blank"><span class="lg-icon"></span><span class="lg-dropdown-text">' + this.core.s.pinterestDropdownText + "</span></a></li>" : "", c += "</ul></span>", this.core.$outer.find(".lg-toolbar").append(c), this.core.$outer.find(".lg").append('<div id="lg-dropdown-overlay"></div>'), a("#lg-share").on("click.lg", function () { b.core.$outer.toggleClass("lg-dropdown-active") }), a("#lg-dropdown-overlay").on("click.lg", function () { b.core.$outer.removeClass("lg-dropdown-active") }), b.core.$el.on("onAfterSlide.lg.tm", function (c, d, e) { setTimeout(function () { a("#lg-share-facebook").attr("href", "https://www.facebook.com/sharer/sharer.php?u=" + encodeURIComponent(b.core.$items.eq(e).attr("data-facebook-share-url") || window.location.href)), a("#lg-share-twitter").attr("href", "https://twitter.com/intent/tweet?text=" + b.core.$items.eq(e).attr("data-tweet-text") + "&url=" + encodeURIComponent(b.core.$items.eq(e).attr("data-twitter-share-url") || window.location.href)), a("#lg-share-googleplus").attr("href", "https://plus.google.com/share?url=" + encodeURIComponent(b.core.$items.eq(e).attr("data-googleplus-share-url") || window.location.href)), a("#lg-share-pinterest").attr("href", "https://www.pinterest.com/pin/create/button/?url=" + encodeURIComponent(b.core.$items.eq(e).attr("data-pinterest-share-url") || window.location.href) + "&media=" + encodeURIComponent(b.core.$items.eq(e).attr("href") || b.core.$items.eq(e).attr("data-src")) + "&description=" + b.core.$items.eq(e).attr("data-pinterest-text")) }, 100) }) }, c.prototype.destroy = function () { }, a.fn.lightGallery.modules.share = c }() });
/**
